...
exports.deleteFoldersByPrefix = exports.listDirectoryFiles = exports.deleteFiles = exports.deleteFile = exports.getFile = exports.createGetPreSignedLink = exports.createPreSignedUploadLink = exports.uploadFiles = exports.uploadLargeFile = exports.uploadFile = exports.s3Config = void 0;
...
const uploadFile = async ({ storageApproach = cloud_multer_1.StorageEnum.memory, Bucket = process.env.AWS_BUCKET_NAME, ACL = "private", path = "general", file }) => {
    ...
    if (!command?.input?.Key) {
        throw new error_response_1.BadRequestException("Failed to generate uplaod key");
    }
...
const deleteFoldersByPrefix = async ({ Bucket = process.env.AWS_BUCKET_NAME, path, Quiet = false }) => {
...
exports.deleteFoldersByPrefix = deleteFoldersByPrefix;
